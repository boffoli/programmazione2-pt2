...
while(r.next()) {
	...
	// In alternativa: accesso posizionale /*System.out.println( r.getString(2) + ", " + r.getString(1) + ": " + r.getString(3) ); 			NB: nell’accesso posizionale, gli indici delle colonne  del ResultSet partono da 1 */
	}
